        ...
        var mostraAula = function(aula, next) {
            ...
            config.async.parallel([
                function(next) {
                    ...
                    mwidget.createWidget(aula.anyAcademic, aula.codiAssignatura, aula.domainFatherId, aula.numeralAula, aula.domainId, domainCodeAula, idp, [], false, false, s, function(err, result) {
