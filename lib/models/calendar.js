module.exports = function(config) {
        ...
        var mostraAula = function(aula, next) {
            ...
            config.async.parallel([
                function(next) {
                    ...
                    mwidget.createWidget(aula.anyAcademic, aula.codiAssignatura, aula.domainFatherId, aula.numeralAula, aula.domainId, domainCodeAula, idp, [], false, s, function(err, result) {
                ...
                llista.forEach(function(a) {
                    var activitat = mactivity.create(a, aula, s);
    ...
    return {
        ...
        docent: function(s, idp, perfil, next) {
