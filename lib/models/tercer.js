module.exports = function(config) {
    ...
    var describe = function (tercer) {
        return {
            ...
            nomComplert: tercer.nomComplert ? config.indicadors.getValor(tercer.nomComplert) : this.getNomComplert(this.nom, this.primerCognom, this.segonCognom, this.tercerCognom)
        }
    };
   ...
   /**
     ...
     * @param next
     */
    var getFitxa = function (idp, s, next) {
        config.services.aulaca.getUserIdPerIdp(this.idp, s, function (err, userid) {
