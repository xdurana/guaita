...
var getFontsInformacioAssignatura = exports.getFontsInformacioAssignatura = function(anyAcademic, codAssignatura, s, next) {
    ...
    service.json(url, function(err, object) {
        return next(err, object ? object.informationSources : config.nc());
    });
}

/**
 * [getWidgetAula description]
 ...
 * @return {[type]}               [description]
 */
var getWidgetAula = exports.getWidgetAula = function(subjectid, classroomid, s, next) {
    var url = config.util.format(
...
/**
 * [getIndicadorsEines description]
 * @param  {[type]}   subjectid   [description]
 * @param  {[type]}   classroomid [description]
 ...
 * @return {[type]}               [description]
 */
var getIndicadorsEines = exports.getIndicadorsEines = function(subjectid, classroomid, resourceid, s, next) {
    var url = config.util.format(
