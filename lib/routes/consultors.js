...
/**
 * Llista de consultors d'una assignatura
...
/**
 * Resum de l'activitat del consultor a les eines
 * @param aula
 * @param s
 * @param next
 */
exports.getResumEines = function(aula, s, next) {
    ...
    async.parallel([
        ...
        function (next) {            
            ws.lrs.byidpandclassroomfromwidgetlast(aula.consultor.idp, aula.domainId, s, function(err, result) {
                if (err) return next(err);
